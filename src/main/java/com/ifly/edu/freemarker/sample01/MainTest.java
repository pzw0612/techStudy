package com.ifly.edu.freemarker.sample01;
...
//    cfg.setClassForTemplateLoading(, "templates");
    
    cfg.setObjectWrapper(new DefaultObjectWrapper());
    cfg.setTemplateLoader(new ClassTemplateLoader(MainTest.class, "/templates"));
