...
public class DateUtil {
    ...
    public static Date addMinute(Date date,int miute){
        Calendar c = Calendar.getInstance();
        c.setTime(date);
        c.add(Calendar.MINUTE,miute);//加减分钟数
        return c.getTime();
    }
    ...
    public static void main(String[] args) {
        ...
        // 日期相差 86400000
        long date = convertDate("2012-02-01 12:00:00");
        System.out.println("" + date + "");
        long date2 = convertDate("2012-02-02 12:00:00");
        System.out.println("" + date2 + "");
        long date3 = convertDate("2012-02-03 12:00:00");
        ...
        //小时相差 3600000
        Date now = new Date();
        Date nowHour = addHour(now,1);
        Date twoHour = addHour(now,2);



        System.out.println(""+ (twoHour.getTime()-nowHour.getTime()));
