...
public class RedisClient {
    ...
    { 
        ...
        jedisPool = new JedisPool(config,"10.10.11.86",6379);
    }
    ...
    { 
        ...
        shards.add(new JedisShardInfo("10.10.11.86", 6379, "master")); 
...
//        shardedJedisPool.returnResource(shardedJedis);
     ...
     private void t1000Test(){
    	 long n =10000000l;
    	  Pipeline pl= jedis.pipelined();
    	 for(long i=0l; i<n; i++){
    		 pl.set("testkey00"+i,"value00"+i);
    	 }
    	 pl.sync();
     }
